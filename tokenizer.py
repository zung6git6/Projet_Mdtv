...
def input_tokenizer(input_file: str) -> list[str]:
    ...
    for line in input_brut:
        ...
        for i, token in enumerate(tokens):
            ...
            next_token = get_next_token(i, tokens)  # Prochain token pour certaines règles contextuelles
            ...
            for regex in re2symbol.keys():
                ...
                if matched:
                    ...
                    list_elements.append(valid_token)  # Ajout du token reconnu à la liste
                    break
